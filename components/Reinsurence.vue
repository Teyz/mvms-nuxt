<template>
  <section class="reinsurance my-5" data-cy="section-reinsurance">
    <div class="container-xxl">
      <div class="row">
        <div class="col-12 col-md-10 d-flex mx-auto p-0">
          <ul
            class="d-flex flex-fill justify-content-evenly flex-wrap m-0"
